...
class SalesForecast(models.Model):
    _name = 'ft.advstock.sales.forecast'
    _description = 'Pronóstico de Ventas por Producto/Mes'
    _order = 'product_id, month_date'
    _rec_name = 'product_id'
    _sql_constraints = [
        ('product_month_company_uniq',
         'unique(product_id, month_date, company_id)',
         'Ya existe un pronóstico de ventas para este producto en este mes y compañía.'),
    ]
    ...
    month_date = fields.Date(
        string='Mes',
        required=True,
        help='Primer día del mes al que corresponde el pronóstico.',
    )
